...
def add_to_database():
    ...
    if table_name.lower() == 'customers':
        ...
        add_customer(first_name, last_name, email, city, registration_date)
        ...
        add_product(product_name, product_producer, price)
    elif table_name.lower() == 'orders':
        employee_id = int(input("Enter employee id: "))
        customer_id = int(input("Enter customer id: "))
        order_date = input("Enter order date: ")
        add_order(employee_id, customer_id, order_date)
...
def remove_component():
    table = input("From which table you want to remove record: ")
    record_id = input(f"What id you want to remove from {table}: ")
    ...
    try:
        ...
        print("Remove the other data first!")
    except Exception as e:
        print(f"Something went wrong, check if the table and id exists, {e}")
    finally:
        cursor.close()
        connection.close()
